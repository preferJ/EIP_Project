...
<script>
    ...
    function onKeyDown(e){   isKeyDown[e.keyCode] = true;}

    function onKeyUp(e){  isKeyDown[e.keyCode] = false;}


    function keyDownHandler(e) {
        if(isKeyDown[37] || e.key == "ArrowRight") {
            rightPressed = true;
        }
        if(isKeyDown[39]|| e.key == "ArrowLeft") {
            leftPressed = true;
        }
        if(isKeyDown[38]|| e.key == "ArrowUp") {
            upPressed = true;
        }
        if(isKeyDown[40] || e.key == "ArrowDown") {
            downPressed = true;
        }
    }
